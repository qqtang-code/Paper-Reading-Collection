...
从注意力本身省算力:让注意力看得更少(声明式稀疏、混合稀疏)→ 让 KV Cache 留得更少(驱逐)→ 让稀疏比按输入自适应 → 让 KV Cache 跨层共享到只需跑半个模型。每篇均含中文精读页与英文版。
...
| HySparse2(2026-09) | 混合稀疏注意力 · 两级 KV 共享 · 长上下文 · Agentic | [hysparse2/](hysparse2/) | [en.html(完整英译)](hysparse2/en.html) |
